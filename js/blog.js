const blogData = {
  1: {
    ...
    content: `
      ...
      <p>The key to effective periodization is balancing hard training phases with adequate recovery periods. Progressive overload gradually increases training demands so your body continues to adapt. This prevents overtraining and keeps your athletes motivated with visible progress.</p>
  ...
  2: {
    ...
    content: `
      ...
      <p><strong>Throughout the day:</strong> Spread protein intake across multiple meals and aim for 1.6-2.0 grams per kilogram of body weight daily. Include nutrient-dense foods like lean meats, fish, eggs, legumes, whole grains, and vegetables for micronutrients.</p>
  ...
  6: {
    ...
    content: `
      ...
      <p><strong>Optimize your sleep environment:</strong> Keep your bedroom cool, dark, and quiet. A comfortable mattress and pillows make a huge difference. Consider white noise if external sounds disturb you.</p>
...
function initBlogModal() {
  ...
  if (!blogModal || !modalBody || !readMoreLinks.length) {
    return;
  }
  ...
  readMoreLinks.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      openBlogModal(this.getAttribute('data-blog-id'));
    });
  });
